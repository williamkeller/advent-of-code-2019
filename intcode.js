  ...
  step() {
    ...
    switch(opcode) {
      ...
      case 21101: // imm imm rel
        ...
        this.incIp(4)
        break
      case 22101: // imm rel rel
        this.setDataRel(3, this.imm(1) + this.rel(2))
        this.incIp(4)
        break
      ...
      case 2107:  // imm rel pos
        ...
        this._ip += 4
        break
      case 2207:  // rel rel pos
        if(this.rel(1) < this.rel(2))
          this.setDataPos(3, 1)
        else 
          this.setDataPos(3, 0)
        this._ip += 4
      ...
      default:
        throw(`Unrecognized opcode ${opcode} at position ${this._ip}!`)
    }
